      ...
      <div className="relative w-full max-w-sm">
        ...
        <form onSubmit={submit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex items-center justify-center gap-2 w-full bg-indigo-600 hover:bg-indigo-500 text-white py-3 rounded-xl font-medium transition-all disabled:opacity-50 hover:shadow-lg hover:shadow-indigo-500/25 mt-1"
          >
